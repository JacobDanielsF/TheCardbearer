    ...
    SubShader
    {
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				fixed4 output = fixed4(0.2, 0.2, 0.25, 0);	// dark background
				...
				{
					output = output - fixed4(0, 0.1, 0, 0);		// green spiral
				}
				...
				{
					output = output - fixed4(0, 0.1, 0.1, 0);	// blue line
				}
				
				if (eq3 % 0.3 < eq2 && eq3 % 0.3 > eq2 - 0.01)
				{
					output = output - fixed4(0.1, 0.1, 0, 0);	// orange line
				}
